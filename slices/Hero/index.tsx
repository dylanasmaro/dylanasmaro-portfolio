    ...
    >
      <div className ="grid min-h-[70vh] grid-cols-1 md:grid-cols-2 items-center">
        ...
        <div className="col-start-1 md:row-start-1">
          <h1 className="mb-8 text-[clamp(5rem,10vmin,10rem)] font-extrabold leading-none-tracking-tighter" aria-label={slice.primary.first_name + " " + slice.primary.last_name}>
