...
export default function ContentList({
  ...
  // Debug: log the contentType to see what is being passed
  console.log("ContentList contentType:", contentType);

  // Make the prefix flexible for any blog-like value
  const urlPrefix = contentType && contentType.toLowerCase().includes("blog")
    ? "/blog_post"
    : "/project";
